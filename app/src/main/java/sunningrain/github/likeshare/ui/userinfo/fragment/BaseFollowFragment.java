...
public class BaseFollowFragment extends BaseFragment implements FollowAndFansView {
    @PresenterVariable
    ...
    public int getLayoutId() {
        return R.layout.fragment_base_follow;
    }
    ...
    protected void lazyLoadData() {
        mFollowAndFansPresenter.getFollowList();
    }
