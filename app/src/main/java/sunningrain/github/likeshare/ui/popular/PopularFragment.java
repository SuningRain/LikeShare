package sunningrain.github.likeshare.ui.popular;
...
public class PopularFragment extends BaseFragment implements WorldAndPopularView {
    @PresenterVariable
    ...
    private OnLoadMoreListener mOnScrollListener;
